...
export default function VaccineCard({name,imgsrc,delRating,onRating} : {name:string,imgsrc:string,delRating:Function,onRating:Function}){
    ...
    return (
        <InteractiveCard>
            ...
            <Rating className='p-auto my-2 object-contain mx-[115px] object-center content-center justify-center' defaultValue={4} value={value} onChange={(e,newValue)=> {setValue(newValue);e.stopPropagation(); onRating(name," : "+newValue)}}/>
