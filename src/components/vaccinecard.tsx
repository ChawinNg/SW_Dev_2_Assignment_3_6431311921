...
export default function VaccineCard({name,imgsrc,delRating,onRating} : {name:string,imgsrc:string,delRating:Function,onRating:Function}){
    ...
    return (
        <InteractiveCard>
            ...
            <Rating id="rate"className='mb-5 object-contain object-center'  value={value} defaultValue={4} onChange={(e,newValue)=> {setValue(newValue);e.stopPropagation(); onRating(name," Rating : "+newValue)}}/>
